...
import (
	...
	typedseccompv1alpha1 "github.com/imjasonh/seccomp-profile/pkg/apis/clientset/versioned/typed/seccomp/v1alpha1"
	...
	if untyped == nil {
		if injection.GetConfig(ctx) == nil {
			logging.FromContext(ctx).Panic(
				"Unable to fetch github.com/imjasonh/seccomp-profile/pkg/apis/clientset/versioned.Interface from context. This context is not the application context (which is typically given to constructors via sharedmain).")
		} else {
			logging.FromContext(ctx).Panic(
				"Unable to fetch github.com/imjasonh/seccomp-profile/pkg/apis/clientset/versioned.Interface from context.")
		}
	}
...
// SeccompV1alpha1 retrieves the SeccompV1alpha1Client
func (w *wrapClient) SeccompV1alpha1() typedseccompv1alpha1.SeccompV1alpha1Interface {
	return &wrapSeccompV1alpha1{
		dyn: w.dyn,
	}
}

type wrapSeccompV1alpha1 struct {
	dyn dynamic.Interface
}

func (w *wrapSeccompV1alpha1) RESTClient() rest.Interface {
...
func (w *wrapSeccompV1alpha1SeccompProfileImpl) Create(ctx context.Context, in *v1alpha1.SeccompProfile, opts v1.CreateOptions) (*v1alpha1.SeccompProfile, error) {
...
func (w *wrapSeccompV1alpha1SeccompProfileImpl) List(ctx context.Context, opts v1.ListOptions) (*v1alpha1.SeccompProfileList, error) {
	...
	out := &v1alpha1.SeccompProfileList{}
	if err := convert(uo, out); err != nil {
		return nil, err
	}
	return out, nil
...
func (w *wrapSeccompV1alpha1SeccompProfileImpl) Update(ctx context.Context, in *v1alpha1.SeccompProfile, opts v1.UpdateOptions) (*v1alpha1.SeccompProfile, error) {
	in.SetGroupVersionKind(schema.GroupVersionKind{
		Group:   "seccomp.imjasonh.dev",
		Version: "v1alpha1",
		Kind:    "SeccompProfile",
...
func (w *wrapSeccompV1alpha1SeccompProfileImpl) UpdateStatus(ctx context.Context, in *v1alpha1.SeccompProfile, opts v1.UpdateOptions) (*v1alpha1.SeccompProfile, error) {
	in.SetGroupVersionKind(schema.GroupVersionKind{
		Group:   "seccomp.imjasonh.dev",
		Version: "v1alpha1",
		Kind:    "SeccompProfile",
...
func (w *wrapSeccompV1alpha1SeccompProfileImpl) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
