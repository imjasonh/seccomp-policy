...
import (
	...
	versionedscheme "github.com/imjasonh/seccomp-profile/pkg/apis/clientset/versioned/scheme"
...
const (
	defaultControllerAgentName = "seccompprofile-controller"
	defaultFinalizerName       = "seccompprofiles.seccomp.imjasonh.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	seccompprofileInformer := seccompprofile.Get(ctx)

	lister := seccompprofileInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "seccomp.imjasonh.dev.SeccompProfile"),
	)
